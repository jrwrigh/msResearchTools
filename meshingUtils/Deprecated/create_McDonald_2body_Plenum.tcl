...
ic_delete_empty_parts 
ic_geo_set_part surface {srf.00.5} INTERFACEPLEN 0
ic_delete_empty_parts 
...
# Create Ogrid
ic_hex_rescale_ogrid 3 0 40 m GEOM DIFFUSER SHELL LUMP PLENUM INLET WALLS OUTLET abs

# Adjust Separation Distance
ic_hex_rescale_ogrid 8 0 $ogrid_separation_space_PLEN m GEOM DIFFUSER SHELL LUMP PLENUM INLET WALLS OUTLET abs
