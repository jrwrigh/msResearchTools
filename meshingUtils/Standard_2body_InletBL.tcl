...
set {in_BL_r} 127
    # the radius at which the BL separation face is created
...
set {ogrid_diffinner_layern} 25
    # number of layers in diffuser inner ring
set {ogrid_diffinner_initheight} 0.36
    # value of initial height layer in mm

set {ogrid_diffBL_layern} 25
    # number of layers in diffuser inner ring
set {ogrid_diffBL_initheight} 0.02
    # value of initial height layer in mm
...
set {out_BL_r} [expr $in_BL_r * ($out_r / $in_r)]
    # BL radius @ diffuser outlet, expands with area expansion
...
## Creating the BL domain inlet circle
ic_curve arc_ctr_rad GEOM crv.16 "GEOM.19 GEOM.21 pnt.11 $in_BL_r 0 360"
## Make the diffuser inlet BL surface
ic_curve arc_ctr_rad GEOM crv.17 "pnt.15 GEOM.25 pnt.12 $in_BL_r 0 360"

# Trim the circle into the domain inlet face
ic_geo_trim_surface srf.00 crv.16 1

# Create part for the InletBL
ic_geo_set_part surface {srf.00.cut.0} INLETBL 0
ic_delete_empty_parts 
...
if {$mesh_option == 1} {
    ...
    #### Make the diffinlet BL surface
    ic_curve arc_ctr_rad GEOM crv.18 "GEOM.45 GEOM.33 pnt.13 $out_BL_r 0 360"
    # Trim the circle into the inlet face
    ic_geo_trim_surface srf.00.5 crv.18 1
    ...
    # Split the ring blocks for Boundary Layer ring
    ic_hex_split_grid 41 96 0.5 m GEOM DIFFUSER SHELL LUMP PLENUM INLET WALLS OUTLETMAIN OUTLETWALLS NONSLIPWALL INTERFACEDIFF

    # Associate the middle ring block edges with the BL curves
    ic_hex_set_edge_projection 106 107 0 1 crv.16
    ic_hex_set_edge_projection 105 107 0 1 crv.16
    ic_hex_set_edge_projection 104 105 0 1 crv.16
    ic_hex_set_edge_projection 104 106 0 1 crv.16

    ic_hex_set_edge_projection 110 111 0 1 crv.17
    ic_hex_set_edge_projection 109 111 0 1 crv.17
    ic_hex_set_edge_projection 108 109 0 1 crv.17
    ic_hex_set_edge_projection 108 110 0 1 crv.17

    ic_hex_set_edge_projection 114 115 0 1 crv.18
    ic_hex_set_edge_projection 113 115 0 1 crv.18
    ic_hex_set_edge_projection 112 113 0 1 crv.18
    ic_hex_set_edge_projection 112 114 0 1 crv.18

    # Associate the BL ring block faces with the INLETBL surface part
    ic_hex_project_face node_numbers { 25 41 106 107 } { 37 105 41 107 } { 21 104 25 106 } { 21 37 104 105 } INLETBL

    # Snap edges to curves
    ic_hex_project_to_surface OUTLETWALLS PLENUM OUTLETMAIN NONSLIPWALL INLET LUMP SHELL DIFFUSER GEOM INTERFACEDIFF WALLS

    # Align the inner vertices to the outer vertex's direction
    ic_hex_align_vertices2 86 25 -nodes 106
    ic_hex_align_vertices2 96 41 -nodes 107
    ic_hex_align_vertices2 91 37 -nodes 105
    ic_hex_align_vertices2 81 21 -nodes 104
    ic_hex_align_vertices2 92 70 -nodes 109
    ic_hex_align_vertices2 97 74 -nodes 111
    ic_hex_align_vertices2 87 73 -nodes 110
    ic_hex_align_vertices2 82 69 -nodes 108
    ic_hex_align_vertices2 93 38 -nodes 113
    ic_hex_align_vertices2 98 42 -nodes 115
    ic_hex_align_vertices2 88 26 -nodes 114
    ic_hex_align_vertices2 83 22 -nodes 112

    # SPACING IS FRACTION OF EDGE LENGTH, NOT ABSOLUTE VALUE
    # set edge mesh criteria
    ic_hex_set_mesh 25 106 n $ogrid_diffBL_layern h1 $ogrid_diffBL_initheight h2rel 0.0 r1 1.2 r2 2 lmax 0 exp1 copy_to_parallel unlocked
    ic_hex_set_mesh 106 86 n $ogrid_diffinner_layern h1 $ogrid_diffinner_initheight h2rel 0.0 r1 2 r2 2 lmax 0 exp1 copy_to_parallel unlocked
    ...
    ic_hex_set_mesh 74 42 n $ogrid_diff_sweepn h1 0.0 h2rel 0.0 r1 $ogrid_diff_sweepr r2 2 lmax 0 geo1 copy_to_parallel unlocked
